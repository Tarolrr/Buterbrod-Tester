...
#define GPIOPinNum 16
static PinDescription GPIOPins[GPIOPinNum] = {
		{GPIOA, GPIO_PIN_14, 0, 0}, //P1
		{GPIOA, GPIO_PIN_13, 0, 0}, //P2
		{GPIOB, GPIO_PIN_3, 0, 0},  //P3
		{GPIOA, GPIO_PIN_15, 0, 0}, //P4
		{GPIOA, GPIO_PIN_11, 0, 0}, //P5
		{GPIOA, GPIO_PIN_12, 0, 0}, //P6
		{GPIOB, GPIO_PIN_14, 0, 0}, //P7
		{GPIOB, GPIO_PIN_15, 0, 0}, //P8
		{GPIOB, GPIO_PIN_13, 0, 0}, //P9
		{GPIOB, GPIO_PIN_12, 0, 0}, //P10
		{GPIOA, GPIO_PIN_8, 0, 0},  //P11
		{GPIOB, GPIO_PIN_8, 0, 0},  //P12
		{GPIOB, GPIO_PIN_9, 0, 0},  //P13
		{GPIOA, GPIO_PIN_1, 0, 0},  //P14
		{GPIOA, GPIO_PIN_0, 0, 0},  //P15
		{GPIOA, GPIO_PIN_3, 0, 0},  //P17
};
